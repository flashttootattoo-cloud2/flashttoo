            ...
            <div style={{ background: '#111', borderRadius: editOpen ? 0 : '0 0 20px 20px', borderBottom: editOpen ? 'none' : '1px solid rgba(255,255,255,0.05)', boxShadow: editOpen ? 'none' : '0 40px 100px rgba(0,0,0,0.9)', padding: '16px 20px 0' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12 }}>
                  ...
                  <button onClick={shareStudio}
                    ...
                    {copied ? <span style={{ color: 'rgba(239,255,66,0.5)', fontSize: 14 }}>✓</span> : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(239,255,66,0.38)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>}
                  </button>
                </div>
            ...
            <div style={{ background: '#efff42', borderRadius: '0 0 20px 20px', padding: '20px 20px 24px', boxShadow: '0 40px 100px rgba(0,0,0,0.9)' }}>
              {!keyVerified && !authMode ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  {/* Foto */}
                  <div>
                    <p style={{ fontSize: 11, fontWeight: 700, color: '#000', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 }}>{t('estudio', 'photo_label', 'Foto del estudio')}</p>
                  ...
                  {([
                    ...
                    <div key={key}>
                      <p style={{ fontSize: 11, fontWeight: 700, color: '#000', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>{label}</p>
                      {key === 'description' ? (
                  ...
                  {artists.length > 0 && (
                    <div style={{ borderTop: '1.5px solid rgba(0,0,0,0.12)', paddingTop: 14 }}>
                      <p style={{ fontSize: 11, fontWeight: 700, color: '#000', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>{t('estudio', 'linked_artists', 'Artistas vinculados')}</p>
