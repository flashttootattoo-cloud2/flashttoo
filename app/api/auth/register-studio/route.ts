...
export async function POST(req: NextRequest) {
  ...
  const profileUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://flashttoo.com'}/completar-estudio?user_id=${authUser.id}&email=${encodeURIComponent(email.toLowerCase())}`
