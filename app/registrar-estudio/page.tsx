          ...
          <div className="rounded-2xl p-6" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            {view === 'register' && checkedInvite && !inviteToken && (
              <div className="flex flex-col gap-3 text-center">
                <p className="text-sm font-bold text-white">{t('ingresar', 'studio_invite_title', 'Registro por invitación')}</p>
                <p className="text-xs" style={{ color: 'rgba(255,255,255,0.4)', lineHeight: 1.6 }}>
                  {t('ingresar', 'studio_invite_desc', 'El registro de estudios es solo por invitación. Pedile un link a Flashttoo.')}
                </p>
